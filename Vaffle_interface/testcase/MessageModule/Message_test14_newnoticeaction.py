...
class Message(unittest.TestCase):
    ...
    def testcase_001(self):
        sheet_index = 5
        row = 15
        print("testcase_001 消息中心 - 通知列表- 移除消息，不关注此好友等：")
        ...
        payload1 = {"content": "接口在" + date + "测试发布图片", "images": images, "category": "post"}
        ...
        payload = {'type':'member_post','type_child':'remove','notice_id':notice_id}
