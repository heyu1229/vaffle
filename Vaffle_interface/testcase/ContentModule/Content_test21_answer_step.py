...
class CommentsPublish(unittest.TestCase):
    ...
    def testcase_001(self):
        ...
        payload1 = {"question_id": question_id, "content": "接口在" + date + "测试回答Q/A点踩"}
        ...
        payload = {"answer_id": answer_id, "step_state": 1}
    ...
    def testcase_002(self):
        sheet_index = 1
        row = 32
        print("testcase_002 对回答的取消踩：")

        payload = {"answer_id": answer_id, "step_state": 0}
        member_id = "b9f73f23-7bc6-4de6-9f9b-df2c98076221"
        result = self.r.interface_requests_payload(member_id, sheet_index, row, payload)
