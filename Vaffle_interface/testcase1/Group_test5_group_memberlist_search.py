...
#---------------【群组】搜索群内成员【POST】----------------------
class group_memberlist_search(unittest.TestCase):
    ...
    def testcase_001(self):
        ...
        # 路径
        url = Url().test_url()
        self.base_url1 =url + '/group/memberlist/search'

        payload = {"page": "1","guid": "d4f61542-fc1f-4155-aeec-a46d44e2955f","search_name": "lisa","type":"normal"}
