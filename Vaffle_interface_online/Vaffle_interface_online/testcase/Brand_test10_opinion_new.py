...
class Brands(unittest.TestCase):
    ...
    def testcase_001(self):
        ...
        member_id = '960'
        payload = {"page": 1,"brand_id":14,"topic_id":0}
    ...
    def testcase_002(self):
        ...
        member_id = '960'
        payload = {"page": 2,"last_id":last_id,"brand_id":14,"topic_id":0}
        result = self.r.interface_requests_payload(member_id, sheet_index, row, payload)
   ...
   #-----------------话题下的最新想法列表第1页数据----------------------------------
    ...
    def testcase_003(self):
        ...
        member_id = '960'
        payload = {"page": 1,"brand_id":0,"topic_id":305}
        result = self.r.interface_requests_payload(member_id, sheet_index, row, payload)
        list=result["data"]["list"]
        global last_id1
    ...
    def testcase_004(self):
        ...
        member_id = '960'
        payload = {"page": 2,"last_id":last_id1,"brand_id":0,"topic_id":305}
        result = self.r.interface_requests_payload(member_id, sheet_index, row, payload)
